		...
		<div class="row">
			<div class="col-md-4">
				<div class="card mx-auto">
				  <img class="card-img-top mx-auto" style="width:100%;" src="./images/photo.jpg" alt="Card image cap">
				  <div class="card-body">
				   <h1 class="card-title">Welcome to</h1>
				   <h3> Indian Pharmaceuticals </h3>
						...
						<div class="col-sm-12">
							<div class="card">
						      <div class="card-body">
						        ...
						        <p class="card-text">Create new orders and make invoices</p>
		...
		<div class="row">
			<div class="col-md-4">
				<div class="card">
						...
						<p class="card-text">Manage categories and add new parent and sub categories</p>
			...
			<div class="col-md-4">
				<div class="card">
						...
						<p class="card-text">Manage brand names and add new brand names</p>
			...
			<div class="col-md-4">
				<div class="card">
						...
						<p class="card-text">Manage your products and you add new products</p>
